...
from core.useful_data import STATUS_CONDITIONS
...
Parameters pokemon: the Pokémon under consideration
Parameters stat: the stat we want to estimate
Parameters ivs: individual values for the stat
Parameters evs: effort values for the stat
Parameters nature: the Pokémon's nature
Returns: an estimation of a Pokémon's stat
"""
...
Parameters: pokemon: the Pokémon under consideration
Parameters: stat: the stat we are considering
Parameters: boost: the stages we can force on the stat boost computation
Returns: the modifier to the stat that comes from its boosts
"""
...
Parameters pokemon: the Pokémon under consideration
Parameters stat: the stat under consideration
Parameters weather: the current weather
Parameters terrains: the current terrains on the field
Returns: the modifier to a Pokémon's stat
"""
...
Parameters: pokemon: the Pokémon under consideration
Parameters: stat: the stat we want to compute
Parameters: weather: the current weather
Parameters: terrains: the current terrains on the field
Parameters: is_bot: if the Pokémon belongs to the bot
Parameters: ivs: individual values for the stat
Parameters: evs: effort values for the stat
Parameters: boost: boost's stages for the stat
Parameters: nature: the Pokémon's nature
Returns: the actual stat value by taking into account the boost and all the modifiers
"""
...
Parameters: pokemon: the Pokémon under consideration
Parameters:  stats: the stats we want to consider
Parameters: weather: the current weather
Parameters: terrains: the current terrains on the field
Parameters: is_bot: if the Pokémon belongs to the bot
Returns: String with all the desired stats and their actual values
"""
