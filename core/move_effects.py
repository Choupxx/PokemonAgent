...
from core.useful_data import STATUS_CONDITIONS, HEALING_MOVES
from core.stats import estimate_stat, compute_stat
...
Parameters: attacker: the Pokémon
Returns: Boolean that states if the move has changed type and the new type itself
"""
...
Parameters: is_bot: whether the Pokémon belongs to the bot's team
Returns: Healing and healing percentage of the move
"""
...
Parameters: damage: damage dealt by the move
Parameters: is_bot: whether the Pokémon belongs to the bot's team
Returns: Recoil dealt by the move
"""
