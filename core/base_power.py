...
from core.useful_data import STATUS_CONDITIONS, IGNORE_EFFECT_ABILITIES_IDS
...
Returns: Base power modifier that takes into account abilities and items
"""
...
Parameters: move: move under consideration
Parameters: move_type: the current type of the move
Parameters: attacker: attacking Pokémon
Parameters: defender: defending Pokémon
Parameters: modifier: if the modifier is given instead of the actual base power
Returns: the actual base power or the modifier
"""
